...
import { Clock, Shirt, Sun, Cookie, Thermometer, Battery } from 'lucide-react'

export default function TipsModalNav() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <li className="text-[#000000] font-bold cursor-pointer hover:text-[#8b4513]">
          Dicas
        </li>
      </DialogTrigger>
